...
![](/assets/img/Peek%202025-12-20%2012-15.gif)

추가된 장애물에 대해 Global & Local Costmap 모두 감지되는 것을 확인할 수 있다.
![](/assets/img/Peek%202025-12-20%2012-21.gif)
...
![](/assets/img/Peek%202025-12-20%2012-26.gif)

obstacle layer enabled를 끄고, 경로를 생성하면,
![](/assets/img/Peek%202025-12-20%2012-29.gif)
...
![](/assets/img/Peek%202025-12-20%2012-30.gif)
...
---
# Local Costmap
![](/assets/img/Peek%202025-12-20%2012-38.gif)
