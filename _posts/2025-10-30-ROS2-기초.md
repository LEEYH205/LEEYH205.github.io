...
## lidar
![ROS2 스크린샷](/assets/img/ros2nav2/img/Screenshot%20from%202025-10-31%2015-40-34.png)

![](/assets/img/ros2nav2/img/Screenshot%20from%202025-10-31%2015-46-57.png)


## 시뮬레이션 실습
### 목표
- TIAGo 로봇의 라이다 센서 데이터를 구독(Subscribe)하고, 이를 바탕으로 로봇의 이동 명령을 발행(Publish)하는 통합 노드 생성
![](/assets/img/ros2nav2/gif/Peek_2025-10-31_16-36.gif)
...
![](/assets/img/ros2nav2/img/Screenshot%20from%202025-10-31%2017-31-25.png)
